...
- **A lista de instituições** vem de duas listas públicas do **Banco Central**, em dois conjuntos separados de propósito: a **lista principal** com as ~470 instituições com código COMPE (participantes do STR) e um conjunto próprio com as ~640 **instituições só-Pix** (fintechs, IPs, cooperativas afiliadas — CSV diário oficial de participantes ativos do Pix). Total: **1.113 instituições**, com atributos de participação no Pix, sem poluir a lista principal.
- **Os logos** vêm do **diretório de participantes do Open Finance Brasil** — onde cada instituição publica e mantém a própria marca — e, para quem não participa, do **site oficial da própria instituição** (com curadoria visual). Afiliadas de sistemas cooperativos (Sicoob, Sicredi, Cresol, Unicred) recebem o logo do sistema por regra explícita, **compartilhando um único arquivo por marca** — 473 instituições com logo em ~160 arquivos distintos (~1,7 MB).
